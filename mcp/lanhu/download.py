...
from common import IMAGE_EXTENSIONS, prepare_output_dir
from lanhu.api import create_client, get_lanhu_image, is_lanhu_image_url
    ...
    async with create_client(cookie, image_accept=True) as client:
        for asset in assets:
            ...
            try:
                ...
                response = await get_lanhu_image(client, source_url)
                content_type = (
